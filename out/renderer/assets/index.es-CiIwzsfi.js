import { c as commonjsGlobal, t as toPropertyKey$3, g as getDefaultExportFromCjs } from "./index-BktLYUb4.js";
...
var ordinaryToPrimitive$1 = function(input, pref) {
  var fn, val;
  if (pref === "string" && isCallable$g(fn = input.toString) && !isObject$a(val = call$h(fn, input)))
    return val;
  if (isCallable$g(fn = input.valueOf) && !isObject$a(val = call$h(fn, input)))
    return val;
  if (pref !== "string" && isCallable$g(fn = input.toString) && !isObject$a(val = call$h(fn, input)))
    return val;
...
var environment = function() {
  ...
  if (userAgentStartsWith("Node.js/"))
    return "NODE";
  if (globalThis$b.Bun && typeof Bun.version == "string")
    return "BUN";
  if (globalThis$b.Deno && typeof Deno.version == "object")
    return "DENO";
  if (classof$7(globalThis$b.process) === "process")
    return "NODE";
  if (globalThis$b.window && globalThis$b.document)
    return "BROWSER";
  return "REST";
}();
...
var dispatchEvent = function(name, promise2, reason) {
  ...
  if (!NATIVE_PROMISE_REJECTION_EVENT && (handler = globalThis$5["on" + name]))
    handler(event);
