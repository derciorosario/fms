...
function TotalCard({items,page}) {
  ...
  return (
    <div className="flex items-center pr-[1rem] [&>_div]:shadow [&>_div]:rounded-[0.4rem] mb-5 [&>_div]:min-h-[80px] [&>_div]:min-w-[170px] [&>_div]:mr-[10px] justify-start">
                       {items.map((i,_i)=>(
                            <div className="flex items-center bg-white  px-2 py-2" key={_i}>
