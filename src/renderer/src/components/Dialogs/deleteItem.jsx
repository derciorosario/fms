...
export default function CircularIndeterminate({res,show,loading,messageContent}) {
  return (
<>
<div id="popup-modal" tabindex="-1" class={`${!show ? 'hidden':'flex'} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center  items-center w-full md:inset-0 h-[100%] max-h-full bg-[rgba(0,0,0,0.3)]`}>
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow py-8">
            {!loading && <>
             <button onClick={()=>res(false)} type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="popup-modal">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                {messageContent ||  <h3 class="mb-1 text-lg font-normal text-gray-500">{t('common.sure-to-continue')}</h3>}
