...
import ExpandMoreOutlinedIcon from '@mui/icons-material/ExpandMore'; //Outlined
import PaymentsOutlinedIcon from '@mui/icons-material/Payments';
...
<aside id="sidebar-multi-level-sidebar" className="relative top-0 left-0 z-40 w-64 h-screen transition-transform" aria-label="Sidebar">
   <div className="h-full px-3 py-4 overflow-y-auto bg-white  dark:bg-gray-800">
   <div className="mb-3 flex items-center">
             <div className={`ml-4 text-3xl text-center font-bold`}>FMS</div>
    </div>
      ...
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <button type="button" className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  <PaymentsOutlinedIcon style={getIconStyle('payments')} />
                  <span className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Pagamentos</span>
