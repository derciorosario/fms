...
function App() {
 ...
 async function confirmDelete(res){
     ...
     if(res){
       toast.loading('A eliminar...')
        try{
          await makeRequest({url:`api/users/delete?id=`+[itemsToDelete], error: ``,method:'delete'});
          toast.remove()
          toast.success('Eliminado com sucesso!')
          _delete(items,'managers')
        }catch(e){
          toast.remove()
          console.log(error)
            ...
            <div className="rounded-[0.3rem] shadow bg-white">
              <div className="p-3 flex justify-between">
                   ...
                   <div className="flex items-center">
                    ...
                    <Button variant="contained" onClick={()=>navigate('/managers/create')}>Adicionar</Button>
