    ...
    <>
        ...
        <div className="md:col-span-5">
             ...
             <div className={`mt-10 w-full ${!errors.length || login ?'hidden':''}`}>
                   <span className="text-[17px] mb-2 flex text-gray-600">Erros encontrados:</span>
                   {errors.map(i=>(
                      <>
             ...
             <div className={`${!login ? 'hidden':''}`}>
                <span className="flex items-center mb-6">
                   ...
                   <label className="text-green-500 font-semibold ml-2 table text-[18px]">Empresa criada com sucesso!</label>
                </span>

                <span className="text-gray-500 font-medium ml-2 table text-[17px]">
                    Aproveite todas as funcionalidades disponíveis para manter suas finanças organizadas e sob controle de forma mais eficiente.
                </span>

                <button onClick={()=>{
                    window.location.href="/"
                }} className={`hover:bg-app_orange-300 mt-5 bg-app_orange-400 text-white font-bold py-3 px-8 rounded text-[17px]`}>Iniciar</button>
