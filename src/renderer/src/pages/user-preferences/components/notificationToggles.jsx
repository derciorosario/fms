    ...
    <>
                  <div className="mt-4 flex items-center sm:justify-end">
                            <div className="flex flex-col gap-3">
                                ...
                                onChange={()=>{}}/><span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">PopUps</span>
                                </label>
                                <label for="email" className="relative inline-flex cursor-pointer items-center">
                                <Switch
                                disabled={0===1 ? true : false}
                                inputProps={{ 'aria-label': 'controlled' }}
                                onChange={()=>{}}/><span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Email</span>
                                </label>
                                ...
                                <span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Whatsapp</span>
                                </label>
                            </div>
                        </div>
